  ...
  return (
    <div className="bg-gray-100 px-[200px] h-[60vh] mt-50px">
        ...
        <div>
            ...
            <span className="font-medium">Saving lives, one donation at a time.</span>
         </div>
        <div>
        ...
        <div className="w-full md:w-1/3">
            ...
            <p className="mt-2">123 BloodConnect city, country</p>
            <p className="mt-2">Phone: (+91) 6209504589</p>
            <p className="mt-2">Email: info@HolyBlood.com</p>
