  ...
  return (
    <div className="flex px-[200px] mt-[100px]"> 
        ...
        <div className="m-10">
            ...
            <span>HolyBlood is for public Donation center with blood donation member in the changing health care system</span>
            <ul>
                ...
                <li className="mt-3">4. Examine critcally to ensure alignment</li>
