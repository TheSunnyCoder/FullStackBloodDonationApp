  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="m-[20px] h-[80vh] w-[450px] shadow-lg">
        <h2 className="font-semibold m-[30px]">Prospects</h2>
        <ul className="m-[30px]">
          ...
          <li className="mt-[14px]">
            <strong>Tel :</strong>(91) {prospect.tel}
          </li>
          <li className="mt-[14px]">
        ...
        <button className="bg-red-500 text-white cursor-pointer p-[10px] w-[150px] rounded m-[10px]">
          Approve
        </button>
      </div>
    </div>
